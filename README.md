...
- ถ้าครูเปิดออปชัน **"พิมพ์เหตุผลของแต่ละอันดับ"** ทุกครั้งที่นักเรียนเลือกสาขา ช่องเหตุผลของอันดับนั้นจะเด้งขึ้นมาให้พิมพ์ (บังคับตอบทุกช่อง ไม่ตอบส่งไม่ได้) — เหตุผลถูกเก็บในแท็บ 📝 คำถามเพิ่มเติม (คอลัมน์ "เหตุผลอันดับ 1/2/3…")
